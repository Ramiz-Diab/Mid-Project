...
/// getAllDocuments() fetches every document in a collection with no limit
//             or pagination. This function is dangerous to use on large collections.
//             Add an optional limit parameter:
//             export const getAllDocuments = async (collectionName, limitCount = 50) => {
