...
export default function LoginModal({ onClose, onLogin }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      //  console.log("Firebase User:", user) logs the full user object including
      //              email, phone, role, and profileImage to the browser console.
  ...
  return (
    <Modal onClose={onClose} className="btn-head">
      <div className="login-modal">
        <div className="login-section">
          {/* Btn Close */}
          <div className="btn-sec">
            <button id="closing-Section" onClick={onClose}>
              x
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" id="submit">
              Continue as {role === "user" ? "Regular User" : " DJ/Business"}
            </button>
          </form>
        </div>
      </div>
